...
<?php if(!$products): ?>
  <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4">ยังไม่มีสินค้า — รัน <strong>install_seed.php</strong> หรือ import SQL.</div>
<?php endif; ?>
  ...
  <div class="bg-white rounded shadow p-4">
    ...
    <div class="flex justify-between items-center mt-2">
      ...
      <div>
        ...
        <form method="post" action="/67319010092/cart.php" class="inline">
